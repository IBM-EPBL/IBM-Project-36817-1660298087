...
COS_API_KEY_ID = "pmAEghg_g4S2GzKhP73oCO11ZRpiMfQNni5csKirGp7I"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:iam-identity::a/31d8dd669382442087ecf2de38f4e7cd::serviceid:ServiceId-346deeb7-c2b8-4070-b7d6-c66a80d3c9b2"
...
@app.route('/')
def index():
    files = get_bucket_contents('carimages25')
