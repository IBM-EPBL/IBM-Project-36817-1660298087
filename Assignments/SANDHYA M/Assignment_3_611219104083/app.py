...
COS_INSTANCE_CRN = "crn:v1:bluemix:public:iam-identity::a/ec75e133ffa64f1a901e6f75d4310104::serviceid:ServiceId-7df4ecf3-ddd9-4a0e-8ab8-10a088b6e090"
...
@app.route('/')
def index():
    files = get_bucket_contents('natureimages5')
