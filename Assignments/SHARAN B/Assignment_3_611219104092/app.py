...
COS_API_KEY_ID = "cJ-UVhVJX1O8ZUrZxBiOaAOgxrFXTaESKKVfP8bS_QEF"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:iam-identity::a/e798ee93c34147ef97523b330634c99b::serviceid:ServiceId-ff7413a3-b9d7-4c22-8ab6-30aa3b7ad4d7"
...
@app.route('/')
def index():
    files = get_bucket_contents('bikeimages92')
