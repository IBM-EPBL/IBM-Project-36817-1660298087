...
COS_API_KEY_ID = "gUfxGH-r41c-adshsy4WzhHOFIZ1qs7fs7KZY6O17k1y"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:iam-identity::a/597111f748b546fe9c6f175f94a69d86::serviceid:ServiceId-0547cb72-a524-4eb8-b277-18cc5d95dad8"
...
@app.route('/')
def index():
    files = get_bucket_contents('icelandimages7')
